...
public class WireMockMappingTest {
    ...
    /**
     * WireMockExtension по умолчанию ищет маппинги в src/test/resources/mappings.
     */
    @RegisterExtension
    ...
    void testGetUserFromMapping() throws IOException, InterruptedException {
        // Шаги теста:
        // 1. Подготовка: WireMock автоматически загрузил маппинг из src/test/resources/mappings/user-mapping.json.
    ...
    /**
     * Тест демонстрирует использование файла 'user-200.json' из папки src/test/resources/__files/
    ...
    void testGetUserFromBodyFile() throws IOException, InterruptedException {
        // Шаги теста:
        // 1. Подготовка: WireMock загрузил маппинг из src/test/resources/mappings/user-body-file-mapping.json.
        ...
        //    этого файла из папки src/test/resources/__files/ и возвращает его в теле ответа.
